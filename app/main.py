...
from app.routers import apps, auth, runs, settings as settings_router, tests, users
...
for router in (auth.router, apps.router, tests.router, runs.router, settings_router.router, users.router):
